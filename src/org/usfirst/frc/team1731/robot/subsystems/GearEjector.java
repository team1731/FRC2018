...
public class GearEjector extends Subsystem {
    ...
    private static GearEjector mInstance;

    public static GearEjector getInstance() {
        if (mInstance == null) {
            mInstance = new GearEjector();
        }
        return mInstance;
    }
    ...
    private final Solenoid ejectSolinoid;
//    private final CANTalon mMasterTalon;
    ...
    private GearEjector() {
        ejectSolinoid = Constants.makeSolenoidForId(Constants.kEjectSolenoid);
