...
public class RightScaleToRightSwitch implements PathContainer {
    ...
    public Path buildPath() {
        ...
        sWaypoints.add(new Waypoint(285,83,0,0));
        sWaypoints.add(new Waypoint(239,93,0,50));
        sWaypoints.add(new Waypoint(233,94,0,20));  // changed 234 to 230
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(285, 83), Rotation2d.fromDegrees(0.0)); 
    }
