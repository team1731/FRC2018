...
public class RightSwitchToLeftSwitch implements PathContainer {
    ...
    public Path buildPath() {
        ...
        sWaypoints.add(new Waypoint(250,80,0,0));
        sWaypoints.add(new Waypoint(250,119,0,100));
        sWaypoints.add(new Waypoint(250,260,10,100));
        sWaypoints.add(new Waypoint(220,300,10,80));
        sWaypoints.add(new Waypoint(170,300,10,80));
    //    sWaypoints.add(new Waypoint(165,290,0,50));
        sWaypoints.add(new Waypoint(165,268,0,60));
